      ...
      {success ? (
        ...
        <>
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-5">
            ...
            <div>
              <label className="block text-[16px] font-medium text-[#3A4752] mb-2">Confirm Password</label>
              <div className="relative">
                <input
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#0078FC] hover:bg-[#0060d4] text-white text-[16px] font-bold py-4 px-4 rounded-3xl transition-colors disabled:opacity-70 mt-4 shadow-lg"
            >
