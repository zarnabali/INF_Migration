...
import {
  AnnualIndividualProgramData,
  AnnualIndividualTopBanner,
  AnnualIndividualProducts,
  AnnualIndividualBenefits,
  AnnualIndividualFineprint
...
export default function AnnualIndividualPage() {
  return (
    <PublicLayout>
      <div className="relative overflow-hidden bg-[linear-gradient(180deg,rgba(204,232,250,0.3)_0%,rgba(255,255,255,0)_100%)]">

        {/* Top Banner */}
        <TopBannerProgram topBannerData={AnnualIndividualTopBanner} />

        {/* Accordion Sections */}
        {AnnualIndividualProgramData.map((section, index) => (
        ...
        {/* Benefits Table */}
        <BenefitsTable
          products={AnnualIndividualProducts}
          benefits={AnnualIndividualBenefits}
          fineprint={AnnualIndividualFineprint}
        />
